  ...
  "children": [
    {
      "data": {
        ...
        "entries": [
          ...
          {
            "link": {
              "data": "# A canvas must be manually attached to the figure (pyplot would automatically",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# do it).  This is done by instantiating the canvas with the figure as",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Option 1: Save the figure to a file; can also be a file-like object (BytesIO,",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Option 2: Retrieve a memoryview on the renderer buffer, and convert it to a",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# This image can then be saved to any format supported by Pillow, e.g.:",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Uncomment this line to display the image using ImageMagick's `display` tool.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "#    - `matplotlib.backends.backend_agg.FigureCanvasAgg`",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "#    - `matplotlib.figure.Figure.savefig` / `matplotlib.pyplot.savefig`",
              "type": "str"
            },
            "type": "c1"
          },
