  ...
  "children": [
    {
      "data": {
        ...
        "entries": [
          ...
          {
            "link": {
              "data": "# The scale class must have a member ``name`` that defines the string used",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# to select the scale.  For example, ``ax.set_yscale(\"mercator\")`` would be",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# used to select this scale.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "thresh must be less than pi/2",
              "type": "str"
            },
            "type": "s2"
          },
          ...
          {
            "link": {
              "data": "# There are two value members that must be defined.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# ``input_dims`` and ``output_dims`` specify number of input",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# dimensions and output dimensions to the transformation.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# These are used by the transformation framework to do some",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# error checking and prevent incompatible transformations from",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# being connected together.  When defining transforms for a",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# scale, which are, by definition, separable and have only one",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# dimension, these members should always be set to 1.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Now that the Scale class has been defined, it must be registered so",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# that Matplotlib can find it.",
              "type": "str"
            },
            "type": "c1"
          },
