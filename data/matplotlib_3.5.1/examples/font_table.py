  ...
  "children": [
    {
      "data": {
        ...
        "entries": [
          ...
          {
            "link": {
              "data": "The font face contains the following glyphs:",
              "type": "str"
            },
            "type": "s2"
          },
          ...
          {
            "link": {
              "data": "# A charmap is a mapping of \"character codes\" (in the sense of a character",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# encoding, e.g. latin-1) to glyph indices (i.e. the internal storage table",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# In FreeType>=2.1, a Unicode charmap (i.e. mapping Unicode codepoints)",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# is selected by default.  Moreover, recent versions of FreeType will",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# automatically synthesize such a charmap if the font does not include one",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# (this behavior depends on the font format; for example it is present",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# since FreeType 2.0 for Type 1 fonts but only since FreeType 2.8 for",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# TrueType (actually, SFNT) fonts).",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# The code below (specifically, the ``chr(char_code)`` call) assumes that",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# we have indeed selected a Unicode charmap.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Beware of table's idiosyncratic indexing...",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "Additionally, print all chars to stdout.",
              "type": "str"
            },
            "type": "s2"
          },
