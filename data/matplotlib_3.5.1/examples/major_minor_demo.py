  ...
  "children": [
    {
      "data": {
        ...
        "entries": [
          ...
          {
            "link": {
              "data": "# Make a plot with major ticks that are multiples of 20 and minor ticks that",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# are multiples of 5.  Label major ticks with '.0f' formatting but don't label",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# minor ticks.  The string is used directly, the `StrMethodFormatter` is",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# For the minor ticks, use no labels; default NullFormatter.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Automatic tick selection for major and minor ticks.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Use interactive pan and zoom to see how the tick intervals change. There will",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# be either 4 or 5 minor tick intervals per major interval, depending on the",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# One can supply an argument to `.AutoMinorLocator` to specify a fixed number",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# of minor intervals per major interval, e.g. ``AutoMinorLocator(2)`` would",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# lead to a single minor tick between major ticks.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "#    - `matplotlib.ticker.AutoMinorLocator`",
              "type": "str"
            },
            "type": "c1"
          },
    ...
    },
    {
      "data": {
        "value": {
          "kind": "assets",
          "module": "matplotlib",
          "path": "ex-major_minor_demo.py-0.png",
          "version": "3.5.1"
        }
      },
      "type": "Fig"
    },
    {
      "data": {
        "value": {
          "kind": "assets",
          "module": "matplotlib",
          "path": "ex-major_minor_demo.py-1.png",
          "version": "3.5.1"
        }
      },
      "type": "Fig"
