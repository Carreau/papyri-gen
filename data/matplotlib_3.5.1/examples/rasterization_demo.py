  ...
  "children": [
    {
      "data": {
        ...
        "entries": [
          ...
          {
            "link": {
              "data": "# the values to be color-mapped",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# pcolormesh without rasterization",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# pcolormesh with rasterization; enabled by keyword argument",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# pcolormesh with an overlaid text without rasterization",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# pcolormesh with an overlaid text without rasterization; enabled by zorder.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Setting the rasterization zorder threshold to 0 and a negative zorder on the",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# pcolormesh rasterizes it. All artists have a non-negative zorder by default,",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# so they (e.g. the text here) are not affected.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Save files in pdf and eps format",
              "type": "str"
            },
            "type": "c1"
          },
            ...
            "link": {
              "data": {
                ...
                "reference": {
                  "kind": "module",
                  "module": "matplotlib",
                  "path": "matplotlib.pyplot.savefig",
                  "version": "*"
                },
                "value": "savefig"
              },
          ...
          {
            "link": {
              "data": "# svg backend currently ignores the dpi",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "#    - `matplotlib.artist.Artist.set_rasterized`",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "#    - `matplotlib.axes.Axes.set_rasterization_zorder`",
              "type": "str"
            },
            "type": "c1"
          },
    ...
    },
    {
      "data": {
        "value": {
          "kind": "assets",
          "module": "matplotlib",
          "path": "ex-rasterization_demo.py-0.png",
          "version": "3.5.1"
        }
      },
      "type": "Fig"
