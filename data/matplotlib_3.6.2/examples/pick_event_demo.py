  ...
  "children": [
    {
      "data": {
        ...
        "entries": [
          ...
          {
            "link": {
              "data": "# Simple picking, lines, rectangles and text",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "click on points, rectangles or text",
              "type": "str"
            },
            "type": "s1"
          },
          ...
          {
            "link": {
              "data": "# Make the xtick labels pickable.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Picking with a custom hit test function",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# You can define custom pickers by setting picker to a callable function. The",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# function has the signature::",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "#  hit, props = func(artist, mouseevent)",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# to determine the hit test. If the mouse event is over the artist, return",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# ``hit=True`` and ``props`` is a dictionary of properties you want added to",
              "type": "str"
            },
            "type": "c1"
          },
            ...
            "link": {
              "data": {
                ...
                "reference": {
                  "kind": "module",
                  "module": "numpy",
                  "path": "numpy._typing._generic_alias._GenericAlias.__origin__",
                  "version": "*"
                },
                "value": "ind"
              },
          ...
          {
            "link": {
              "data": "custom picker for line data",
              "type": "str"
            },
            "type": "s1"
          },
          ...
          {
            "link": {
              "data": "# Picking on a scatter plot",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# A scatter plot is backed by a `~matplotlib.collections.PathCollection`.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Images plotted using `.Axes.imshow` are `~matplotlib.image.AxesImage`",
              "type": "str"
            },
            "type": "c1"
          },
            ...
            "link": {
              "data": {
                ...
                "reference": {
                  "kind": "module",
                  "module": "matplotlib",
                  "path": "matplotlib.cm.ScalarMappable.get_array",
                  "version": "*"
                },
                "value": "get_array"
              },
    ...
    },
    {
      "data": {
        "value": {
          "kind": "assets",
          "module": "matplotlib",
          "path": "ex-pick_event_demo.py-0.png",
          "version": "3.6.2"
        }
      },
      "type": "Fig"
    },
    {
      "data": {
        "value": {
          "kind": "assets",
          "module": "matplotlib",
          "path": "ex-pick_event_demo.py-1.png",
          "version": "3.6.2"
        }
      },
      "type": "Fig"
    },
    {
      "data": {
        "value": {
          "kind": "assets",
          "module": "matplotlib",
          "path": "ex-pick_event_demo.py-2.png",
          "version": "3.6.2"
        }
      },
      "type": "Fig"
    },
    {
      "data": {
        "value": {
          "kind": "assets",
          "module": "matplotlib",
          "path": "ex-pick_event_demo.py-3.png",
          "version": "3.6.2"
        }
      },
      "type": "Fig"
