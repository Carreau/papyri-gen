  ...
  "children": [
    {
      "data": {
        ...
        "entries": [
          ...
          {
            "link": {
              "data": "# Defining the axes positions using a gridspec",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# We define a gridspec with unequal width- and height-ratios to achieve desired",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# layout.  Also see the :doc:`/tutorials/intermediate/arranging_axes` tutorial.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Add a gridspec with two rows and two columns and a ratio of 1 to 4 between",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Draw the scatter plot and marginals.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Defining the axes positions using inset_axes",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# `~.Axes.inset_axes` can be used to position marginals *outside* the main",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# axes.  The advantage of doing so is that the aspect ratio of the main axes",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# can be fixed, and the marginals will always be drawn relative to the position",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Create a Figure, which doesn't have to be square.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Create the main axes, leaving 25% of the figure space at the top and on the",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# right to position marginals.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# The main axes' aspect can be fixed.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Create marginal axes, which have 25% of the size of the main axes.  Note that",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# the inset axes are positioned *outside* (on the right and the top) of the",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# main axes, by specifying axes coordinates greater than 1.  Axes coordinates",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# less than 0 would likewise specify positions on the left and the bottom of",
              "type": "str"
            },
            "type": "c1"
          },
