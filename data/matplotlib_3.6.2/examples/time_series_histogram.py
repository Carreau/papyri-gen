  ...
  "children": [
    {
      "data": {
        ...
        "entries": [
          ...
          {
            "link": {
              "data": "# Make some data; a 1D random walk + small fraction of sine waves",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Generate unbiased Gaussian random walks",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Generate sinusoidal signals",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# random walk RMS scaling factor",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Plot series using `plot` and a small value of `alpha`. With this view it is",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# very difficult to observe the sinusoidal behavior because of how many",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# overlapping series there are. It also takes a bit of time to run because so",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# many individual artists need to be generated.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Now we will convert the multiple time series into a histogram. Not only will",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# the hidden signal be more visible, but it is also a much quicker procedure.",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Linearly interpolate between the points in each time series",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# Plot (x, y) points in 2d histogram with log colorscale",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# It is pretty evident that there is some kind of structure under the noise",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "# You can tune vmax to make signal more visible",
              "type": "str"
            },
            "type": "c1"
          },
            ...
            "link": {
              "data": {
                ...
                "reference": {
                  "kind": "module",
                  "module": "numpy",
                  "path": "numpy.lib.twodim_base.histogram2d",
                  "version": "*"
                },
                "value": "histogram2d"
              },
          ...
          {
            "link": {
              "data": "2d histogram and log color scale",
              "type": "str"
            },
            "type": "s2"
          },
          ...
          {
            "link": {
              "data": "# Same data but on linear color scale",
              "type": "str"
            },
            "type": "c1"
          },
          ...
          {
            "link": {
              "data": "2d histogram and linear color scale",
              "type": "str"
            },
            "type": "s2"
          },
          ...
          {
            "link": {
              "data": "#    - `matplotlib.figure.Figure.colorbar`",
              "type": "str"
            },
            "type": "c1"
          },
    ...
    },
    {
      "data": {
        "value": {
          "kind": "assets",
          "module": "matplotlib",
          "path": "ex-time_series_histogram.py-0.png",
          "version": "3.6.2"
        }
      },
      "type": "Fig"
